...
def get_girvan_newman_communities(network: nx.Graph, weight: Optional[str] = None, k: int = 2,
    ...
    communities_generator = nx.community.girvan_newman(network, most_valuable_edge=most_central_edge)
...
# Example usage:
# communities = get_girvan_newman_communities(your_network, k=3)
# print(communities)
